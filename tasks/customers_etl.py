...
RAW_DATA_PATH = "etc/tasks/rawdata"
PROCESSED_DATA_PATH = "etc/tasks/processed_data"
ARCHIVED_DATA_PATH = "etc/tasks/archived_data"
INVALID_RECORDS_TABLE = "data.invalid_customers"
CUSTOMERS_SCHEMA_FILE = "etc/tasks/customer_schema.json"
